		game:GetService("StarterGui"):SetCore("SendNotification", {
			Title = "Banisher";
			Text = "Credits: kogamamloc";
		})
		
		warn("Credits: kogamamloc")
...
local function align(part0, part1)
        ...
        attachment0.Position = Vector3.new(1.5, 0.75, 0) --Custom Positioning Values Here
        attachment0.Orientation = Vector3.new(45, 90, 0) --Custom Rotationing Values here
    ...
    align(hat.Handle, game:GetService("Players").LocalPlayer.Character["Right Arm"])





local hat = game:GetService("Players").LocalPlayer.Character["Evil Aura"]
local function align(part0, part1)
        part0.AccessoryWeld:Destroy()
        local attachment0 = Instance.new("Attachment", part0)
    ...
    align(hat.Handle, game:GetService("Players").LocalPlayer.Character["Head"])
